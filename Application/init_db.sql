...
CREATE TABLE IF NOT EXISTS channel (
    ...
    num_messages INTEGER, -- Number of messages the score is based on
    num_positive INTEGER, -- Number of positive messages
    num_negative INTEGER, -- Number of negative messages
